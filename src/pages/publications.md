...
* Guillame O. Berger, Raphaël M. Jungers, **Formal methods for computing hyperbolic invariant sets for nonlinear systems**, _IEEE Control Systems Letters_, vol. 4, no. 1, pp. 235--240, 2020.

* Guillaume O. Berger, Raphaël M. Jungers, **A converse Lyapunov theorem for $p$-dominant switched linear systems**, _Proceedings of 2019 18th IEEE European Control Conference (ECC)_, pp. 1263--1268, 2019.

* Guillame O. Berger, Fulvio Forni, Raphaël M. Jungers, **Path-complete $p$-dominant switching linear systems**, _Proceedings of 2018 57th IEEE Conference on Decision and Control (CDC)_, pp. 6446--645, 2018.

# Posters

* **Formal methods for computing hyperbolic invariant sets for nonlinear systems**, at 2019 22nd ACM International Conference on Hybrid Systems: Computation and Control (HSCC), April 2019.
